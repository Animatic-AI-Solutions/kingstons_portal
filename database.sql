...
create table public.client_accounts (
  ...
  available_products_id bigint not null,
  ...
  original_template_id bigint null,
  is_bespoke boolean null default true,
  ...
  constraint client_accounts_original_template_id_fkey foreign KEY (original_template_id) references available_portfolios (id)
) TABLESPACE pg_default;
...
create index IF not exists idx_irr_values_fund_date_value on public.irr_values using btree (fund_id, date desc, irr_result) TABLESPACE pg_default;
