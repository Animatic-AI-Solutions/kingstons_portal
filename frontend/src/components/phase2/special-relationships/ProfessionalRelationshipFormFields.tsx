/**
 * ProfessionalRelationshipFormFields Component
 *
 * Form fields specifically for Professional relationships.
 * Shows only fields relevant to professional relationships (accountants, solicitors, advisors, etc.)
 *
 * Features:
 * - Name field (required)
 ...
 * - Notes textarea
 *
 * @module components/ProfessionalRelationshipFormFields
 */
...
export interface ProfessionalRelationshipFormData {
  name: string;
  relationship: string;
...
export interface ProfessionalRelationshipFormFieldsProps {
  formData: ProfessionalRelationshipFormData;
  onChange: (updates: Partial<ProfessionalRelationshipFormData>) => void;
  onBlur: (field: string, value?: any) => void;
  errors: Partial<Record<keyof ProfessionalRelationshipFormData, string>>;
  disabled?: boolean;
  addresses?: Address[];
...
const ProfessionalRelationshipFormFields: React.FC<ProfessionalRelationshipFormFieldsProps> = ({
  formData,
  onChange,
  onBlur,
  errors,
  ...
  const relationshipOptions = PROFESSIONAL_RELATIONSHIPS.map((rel) => ({
    label: rel,
    value: rel,
  }));

  // Status options
  const statusOptions = PROFESSIONAL_STATUS_OPTIONS;
...
export default ProfessionalRelationshipFormFields;
