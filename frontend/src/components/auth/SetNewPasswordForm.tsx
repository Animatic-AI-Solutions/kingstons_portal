...
const SetNewPasswordForm: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (tokenParam) {
      ...
      setError('No reset token found in URL. Please try the password reset process again.');
    }
  }, [location]);
  ...
  const formContent = (
    ...
    >
      ...
      {/* Form */}
      <div className="mb-6">
        <h2 className="text-2xl font-semibold mb-1 text-dark-gray">Set New Password</h2>
