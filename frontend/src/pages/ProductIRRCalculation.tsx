          ...
          <button
            onClick={() => {
              navigate('/report-generator', {
                state: {
                  preSelectedClientGroupId: account?.client_id,
                  preSelectedClientGroupName: account?.client_name
                }
              });
            }}
            className="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-primary-600 border border-transparent rounded-lg hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-all duration-200 shadow-sm"
          >
