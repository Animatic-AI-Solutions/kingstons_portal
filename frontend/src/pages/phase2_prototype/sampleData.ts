...
export const samplePeople: Person[] = [
  ...
  },
  {
    ...
    addressLine5: '',
    postcode: 'TW9 2DH',
    primaryEmail: 'margaret.mitchell@email.com',
    secondaryEmail: '',
    primaryPhone: '020 8940 5678',
    secondaryPhone: '',
    employmentStatus: 'Retired',
    occupation: 'Retired Teacher',
    dateMovedIn: '10/05/1985',
    dateOfBirth: '12/03/1945',
    placeOfBirth: 'Manchester, UK',
    age: 79,
    niNumber: 'GH 90 12 34 F',
    drivingLicenseExpiry: 'Expired 2020',
    passportExpiry: 'Expired 2019',
    otherIds: 'N/A',
    amlResult: 'Passed',
    amlDate: '10/01/2020',
    safeWords: ['Manchester', 'Teacher', 'Oak'],
    shareDataWith: 'James Mitchell',
    notes: 'Deceased 15/02/2024. Had significant estate planning completed before passing. Named beneficiary on several policies.',
    status: 'Deceased',
  },
];
...
export const sampleRelationships: SpecialRelationship[] = [
  {
    ...
    email: 'r.thompson@accountingfirm.co.uk',
  ...
  },
  {
    ...
    type: 'personal',
    name: 'David Thompson',
    dateOfBirth: '05/11/1942',
    age: 81,
    relationship: 'Father-in-law',
    isDependency: false,
    associatedPerson: ['Sarah Mitchell'],
    address: '25 Greenfield Avenue, Bristol, BS6 5PQ',
    contactDetails: '0117 924 5678',
    status: 'Deceased',
    notes: 'Deceased 22/08/2023. Sarah\'s father. Estate settlement completed. Was previously a professional advisor for property matters.',
  },
];
...
export const sampleActions: Action[] = [
  ...
  },
  {
    ...
    description: 'Fill out the updated FinaMetrica risk assessment',
    assignedTo: 'Client',
    dueDate: '2024-11-01',
    status: 'In Progress',
    priority: 'High',
