...
These fixtures provide test database connections, HTTP clients, and test data
for testing FastAPI API endpoints.
"""
import pytest
...
async def async_client():
    ...
    This client is configured to make requests to the FastAPI application
...
async def unauthenticated_client():
    ...
    This client is used for testing authentication/authorization failures.
    """
    from main import app
